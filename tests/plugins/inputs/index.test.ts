...
describe('Input Plugins Index', () => {
  describe('getInputPluginRegistry', () => {
    ...
    it('should contain all expected plugins', () => {
      ...
      expect(registry.has('lidarr')).toBe(true);
  ...
  describe('exports', () => {
    ...
    it('should export LidarrPlugin', () => {
      expect(LidarrPlugin).toBeDefined();
    });

    it('should export BazarrPlugin', () => {
      expect(BazarrPlugin).toBeDefined();
    });

    it('should export ProwlarrPlugin', () => {
      expect(ProwlarrPlugin).toBeDefined();
    });
